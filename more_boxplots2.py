...
def setBoxColors(bp, ok: bool):
    ...
    setp(bp['boxes'][k], color='brown')
    setp(bp['caps'][l], color='brown')
    setp(bp['caps'][m], color='brown')
    setp(bp['whiskers'][l], color='brown')
    setp(bp['whiskers'][m], color='brown')
    setp(bp['fliers'][k], markeredgecolor='brown', markersize=0.15)
    setp(bp['medians'][k], color='brown')
    
    k += 1
    l += 2
    m += 2 
    setp(bp['boxes'][k], color='green')
    setp(bp['caps'][l], color='green')
    setp(bp['caps'][m], color='green')
    setp(bp['whiskers'][l], color='green')
    setp(bp['whiskers'][m], color='green')
    setp(bp['fliers'][k], markeredgecolor='green', markersize=0.15)
    setp(bp['medians'][k], color='green')
...
iter22 = _read_file("cutoff_and_group_model0_ef4", "pairs")
...
iter22 = _read_file("cutoff_and_group_model0_ef4", "triples")
...
iter22 = _read_file("cutoff_and_group_model0_ef4", "quatres")
...
#iter22 = _read_file("cutoff_and_group_model0_ef4", "fifth")
...
plt.xlabel("iterace")
plt.tight_layout()
savefig('boxcompare2.png', dpi=1000)
