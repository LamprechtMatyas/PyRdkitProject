...
# first boxplot pair
A = [[0.9282435897435901], [0.9282435897435901], [0.9282435897435901], [0.9282435897435901]] 
bp = boxplot(A, positions=[0.7,0.9,1.1,1.3], widths= 0.19)
setBoxColors(bp, True)

# second boxplot pair
iter21 = _read_file("active_group_model_ecfp4", "pairs")
iter22 = _read_file("add_group_model_ecfp4", "pairs")
iter23 = _read_file("delete_index_group_model_ecfp4", "pairs")
iter24 = _read_file("group_and_add_model", "pairs")
...
# thrid boxplot pair
iter21 = _read_file("active_group_model_ecfp4", "triples")
iter22 = _read_file("add_group_model_ecfp4", "triples")
iter23 = _read_file("delete_index_group_model_ecfp4", "triples")
iter24 = _read_file("group_and_add_model", "triples")
C = [iter21, iter22, iter23, iter24]

bp = boxplot(C, positions=[2.7,2.9,3.1,3.3], widths= 0.19)
setBoxColors(bp, True)

iter21 = _read_file("active_group_model_ecfp4", "quatres")
iter22 = _read_file("add_group_model_ecfp4", "quatres")
iter23 = _read_file("delete_index_group_model_ecfp4", "quatres")
iter24 = _read_file("group_and_add_model", "quatres")
D = [iter21, iter22, iter23, iter24]

bp = boxplot(D, positions=[3.7,3.9,4.1,4.3], widths= 0.19)
setBoxColors(bp, True)

iter21 = _read_file("active_group_model_ecfp4", "fifth")
iter22 = _read_file("add_group_model_ecfp4", "fifth")
iter23 = _read_file("delete_index_group_model_ecfp4", "fifth")
iter24 = _read_file("group_and_add_model", "fifth")
E = [iter21, iter22, iter23, iter24]

bp = boxplot(E, positions=[4.7,4.9,5.1,5.3], widths= 0.19)
setBoxColors(bp, True)

iter21 = _read_file("active_group_model_ecfp4", "sixth")
iter22 = _read_file("add_group_model_ecfp4", "sixth")
iter23 = _read_file("delete_index_group_model_ecfp4", "sixth")
iter24 = _read_file("group_and_add_model", "sixth")
F = [iter21, iter22, iter23, iter24]

bp = boxplot(F, positions=[5.7,5.9,6.1,6.3], widths= 0.19)
setBoxColors(bp, True)

iter21 = _read_file("active_group_model_ecfp4", "septh")
iter22 = _read_file("add_group_model_ecfp4", "septh")
iter23 = _read_file("delete_index_group_model_ecfp4", "septh")
iter24 = _read_file("group_and_add_model", "septh")
G = [iter21, iter22, iter23, iter24]

bp = boxplot(G, positions=[6.7,6.9,7.1,7.3], widths= 0.19)
setBoxColors(bp, True)

iter21 = _read_file("active_group_model_ecfp4", "octagon")
iter22 = _read_file("add_group_model_ecfp4", "octagon")
iter23 = _read_file("delete_index_group_model_ecfp4", "octagon")
iter24 = _read_file("group_and_add_model", "octagon")
H = [iter21, iter22, iter23, iter24]

bp = boxplot(H, positions=[7.7,7.9,8.1,8.3], widths= 0.19)
setBoxColors(bp, True)

iter21 = _read_file("active_group_model_ecfp4", "ninth")
iter22 = _read_file("add_group_model_ecfp4", "ninth")
iter23 = _read_file("delete_index_group_model_ecfp4", "ninth")
iter24 = _read_file("group_and_add_model", "ninth")
...
#R.set_visible(False)
ax.legend([bp["boxes"][0],bp["boxes"][1],bp["boxes"][2],bp["boxes"][3]], ["AS", "PI", "OSI", "VES"], loc="upper left", prop={'size': 8})
plt.ylabel("AUC")
plt.xlabel("iterace")
plt.tight_layout()
savefig('boxcompare.png', dpi=1000)
#show()